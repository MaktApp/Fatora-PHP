...
<form method="POST" action="" accept-charset="UTF-8">
    ...
    <input type="hidden"  id="customerEmail" value="testPament@testPayment.com">
    <input type="hidden"  id="customerName" value="gust">
    <input type="hidden"  id="customerPhone" value="+9639449871">
    <input type="hidden"  id="customerCountry" value="QATAR">
    <input type="hidden"  id="lang" value="en">
    <input type="hidden"  id="note" value="Demo of Payment">
    
    <button class="btn btn-pay" name="submit" type="button"><i class="fa fa-money"></i> Pay </button>
</form>
